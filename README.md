...
The objective of this project is to create an application that beginner climbers can use to search for climbing routes that fit their level and supply them with the information needed to be safe. 
...
1. Connect to your local MySQL database and import the DDL/DML (Dump20201210.sql)
1. In main.py line 17, update the database connection credentials to your local MySQL credentials
